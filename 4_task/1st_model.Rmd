...
docs = lapply(docs,corpus_sample, size = 500000)
...
#sqldf("select gram_1, gram_2, SUM(frequency) from dt_freq_5_grams  group by gram_1,gram_2 having gram_1 = 'i''d' and gram_2 IN ('die','eat','give','sleep')"  )
sqldf("select gram_1, gram_2, gram_3, SUM(frequency) from dt_freq_5_grams  group by gram_1,gram_2 having gram_1 = 'about' and gram_2 = 'his'  ")
#and gram_3 IN ('die','eat','give','sleep')"
